<%-- 
    Document   : index
    Created on : 16 abr. 2021, 2:40:58
    Author     : kristian
--%>
...
<html lang="en">
    <head>
        <spring:url value="/resources" var="public" />
        ...
        <title>Cinetflix | Bienvenido</title>
          ...
          ================================================== -->
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">         
                        <img src="${public}/images/slide1.jpg" alt="Slide" title="Some text" >
                    </div>
                    <div class="item">         
                        <img src="${public}/images/slide2.jpg" alt="Slide" title="Some text" >
                    </div>
                    <div class="item">         
                        <img src="${public}/images/slide3.jpg" alt="Slide" title="Some text" >
                    </div>
                    <div class="item">         
                        <img src="${public}/images/slide4.jpg" alt="Slide" title="Some text" >
                    </div>
                </div>
            ...
            <div class="row page-header">          
                <div class="col-lg-12">         
                    ...
                    <form class="form-inline" action="${root}search" method="GET">
                        <div class="form-group">
                            <label for="fecha">Fecha: </label>
                            <select id="fecha" name="date" class="form-control">
                                <c:forEach items="${nextDates}" var="nextDate">
                                    <c:choose>
                                        <c:when test="${nextDate.equals(dateSelected)}">
                                            <option value="${dateSelected}" selected>${dateSelected}</option>
                                        </c:when>
                                        <c:otherwise>
                ...
                <div class="row">
                    <c:forEach items="${movies}" var="movie">
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            ...
                            <p>
                                <a class="btn btn-sm btn-primary" href="${root}details/${movie.id}/${date}" role="button">
                    ...
                    <div class="col-sm-12 blog-main">
                        ...
                        <div class="blog-post">              
                            <h3 class="blog-post-title">
                                Julia Roberts protagonizará The Bookseller
                            </h3>
